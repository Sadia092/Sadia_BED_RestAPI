...
public class StudentController {
    ...
    public String showFormForUpdate(@RequestParam("studentId") int theId,
                                    Model theModel) throws StudentException {
    ...
    public String save(@RequestParam("id") int id,
                       @RequestParam("firstName") String firstName,@RequestParam("lastName") String lastName,@RequestParam("course") String course,@RequestParam("country") String country) throws StudentException {
        Student theStudent=new Student();
        if(id!=0)
        {
